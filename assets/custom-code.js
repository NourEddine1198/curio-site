document.addEventListener('DOMContentLoaded', function () {
  ...
  function injectHomePageStyles() {
    ...
    style.textContent = [
      ...
      '.curio-home-summary-row.discount span{color:#10643d}',
      '.coupon-row{display:flex;gap:8px}',
      '.coupon-row input{flex:1}',
      '.coupon-apply-btn{min-height:52px;padding:0 20px;border-radius:14px;border:none;background:linear-gradient(135deg,#f5cb48,#e6b800);color:#21162f;font-family:inherit;font-weight:700;font-size:.95rem;cursor:pointer;transition:transform .15s ease;white-space:nowrap}',
      '.coupon-apply-btn:hover{transform:translateY(-1px)}',
  ...
  function renderStoreHomePage() {
    ...
    document.body.innerHTML = [
      ...
      '            </select>',
      '          </div>',
      '          <div class="curio-home-field" id="curio-coupon-group">',
      '            <label for="curio-coupon-input">' + STORE_COPY.common.labels.coupon + '</label>',
      '            <div class="coupon-row"><input id="curio-coupon-input" name="coupon" type="text" placeholder="' + STORE_COPY.common.placeholders.coupon + '" aria-label="' + STORE_COPY.common.labels.coupon + '" autocomplete="off"><button type="button" id="curio-coupon-apply" class="coupon-apply-btn">\u0637\u0628\u0651\u0642</button></div>',
      '            <p class="field-note" id="curio-coupon-note"></p>',
      '          </div>',
      ...
      '            <div class="curio-home-summary-row discount" id="curio-summary-discount-row" style="display:none"><span>\u0627\u0644\u062a\u062e\u0641\u064a\u0636</span><span id="curio-summary-discount"></span></div>',
